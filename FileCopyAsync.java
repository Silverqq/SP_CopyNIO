...
public class FileCopyAsync {
    ...
    public static void main(String[] args) {
        Path sourceFile1 = Path.of("C:\\Users\\79623\\OneDrive\\Рабочий стол\\Ассинхронное копироваине\\Откуда копировать 1.txt");
        Path sourceFile2 = Path.of("C:\\Users\\79623\\OneDrive\\Рабочий стол\\Ассинхронное копироваине\\Откуда копировать 2.txt");
        Path targetFile1 = Path.of("C:\\Users\\79623\\OneDrive\\Рабочий стол\\Ассинхронное копироваине\\Куда копировать 1.txt");
        Path targetFile2 = Path.of("C:\\Users\\79623\\OneDrive\\Рабочий стол\\Ассинхронное копирование\\Куда копировать 2.txt");
